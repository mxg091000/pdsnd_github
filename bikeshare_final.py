...
def get_filters():
    ...
    # TO DO: get user input for month (january, february, ... , june)
        month = choice("\nFrom January to June, for what month(s), do you "
                       "want to filter the data?\nYou can choose: january,february,march,april,may,june or type in desired months separated by a comma.\n>",
                       months)

    # TO DO: get user input for day of week (monday, tuesday, ... sunday)
        day = choice("\nFor what weekday(s), do you want to filter bikeshare "
                     "data?\nYou can choose: sunday,monday,tuesday,wednesday,thursday,friday,saturday or type in desired days separated by a comma.\n>", weekdays)
...
def time_stats(df):
    ...
    print('For the selected, the month with the most travels is: ' +
